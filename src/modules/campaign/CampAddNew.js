...
import startCamp from "../../images/startCamp.png";
...
const categories = ["education", "home"];
...
const CampAddNew = () => {
  ...
  // su dung quill de import image vao content
  ...
  const handleDropdownOption = (name, value) => {
    setValue(name, value);
  };
  ...
  return (
    <div className="bg-white py-10 px-[66px] rounded-xl">
      <div className="mb-10 text-center">
        <h1 className="inline-flex gap-x-2 px-[59px] py-4 bg-text4 text-text2 bg-opacity-5 font-bold text-[25px] rounded-xl ">
          Start a Campaign <img src={startCamp} alt="" />
        </h1>
      </div>
      <form onSubmit={handleSubmit(handleAddNewCamp)}>
            ...
            <Dropdown>
              ...
              <Dropdown.List>
                {categories.map((category) => (
                  <Dropdown.Option
                    key={category}
                    onClick={() => handleDropdownOption("category", category)}
                  >
        ...
        <FormRow>
          <FormGroup>
            ...
            <UploadImage onChange={setValue} name="featured-img"></UploadImage>
          </FormGroup>
          <FormGroup>
        ...
        <div className="flex w-full mb-10 rounded-lg bg-secondary">
          <div className="flex items-center justify-start px-12 py-8 gap-x-5">
            <span>
              <svg
                width="40"
                height="40"
              ...
              >
                <g clipPath="url(#clip0_2263_14615)">
                  <path
            ...
            <h3 className="text-[25px] font-bold leading-[38px] text-white">
                ...
                {countries.length > 0 &&
                  countries.map((country) => (
                    <Dropdown.Option
                      ...
                      onClick={() =>
                        handleDropdownOption("country", country?.name?.common)
                      }
                    >
                      {country?.name?.common}
                    </Dropdown.Option>
