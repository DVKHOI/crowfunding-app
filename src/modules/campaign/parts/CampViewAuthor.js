    ...
    <div className="flex items-center mb-8 gap-x-5">
      ...
      <div className="flex flex-col flex-1">
        ...
        <div className="flex items-center text-sm gap-x-3">
          <p className="font-semibold text-primary">02 Campaign</p>
          <p className="w-[6px] h-[6px] rounded-full bg-text3"></p>
          <p className="font-normal text-text3">Dhaka, Bangladesh</p>
        </div>
      </div>
    </div>
  );
